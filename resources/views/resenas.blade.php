...
<section class="bg-[#0000004a]">
    <div class="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      ...
      <div class="mt-8">
        <form action="{{ route('resenas.store') }}" method="POST" class="bg-gray-800 bg-opacity-60 p-6 rounded-lg" data-action="{{ route('resenas.store') }}">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <textarea id="review" name="review" class="w-full p-2 rounded" rows="4" required></textarea>
            </div>
