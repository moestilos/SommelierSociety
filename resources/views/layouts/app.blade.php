...
<body class="flex flex-col min-h-screen">
    ...
    <footer class="text-gray-400 wine-gradient py-2 body-font">
        <div class="container max-w-4xl px-5 py-4 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <p class="text-sm text-gray-400 sm:ml-4 sm:py-2 sm:mt-0 mt-4">© 2025 South Wine Academy —
