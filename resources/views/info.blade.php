...
<div class="relative flex items-center justify-center min-h-screen bg-cover bg-center" style="background-image: url('{{ asset('img/vino.jpg') }}');">
    ...
    <div class="relative z-10 max-w-4xl p-8 bg-white bg-opacity-90 rounded-lg shadow-lg">
        <h1 class="text-4xl font-bold text-center text-rose-600 mb-8">Información de Cursos de Sommeliers</h1>
        ...
        <h2 class="text-2xl font-semibold text-rose-600 mb-4">Detalles del Curso</h2>
        <ul class="list-disc list-inside text-lg text-gray-800 mb-4">
        ...
        <h2 class="text-2xl font-semibold text-rose-600 mb-4">Inscripción</h2>
        <p class="text-lg text-gray-800 mb-4">
            Para inscribirte en nuestros cursos, visita nuestra página de <a href="{{ url('/tarifas') }}" class="text-rose-600 hover:underline">Tarifas</a> o contáctanos a través de nuestro <a href="{{ url('/contacto') }}" class="text-rose-600 hover:underline">Formulario de Contacto</a>.
        </p>
    </div>
</div>
@endsection