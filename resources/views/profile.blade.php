...
<header class="text-gray-400 bg-black p-2 body-font">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
            ...
            <a href="{{ url('/profile') }}" class="mr-5 hover:text-yellow">Profile</a>
...
<div class="text-center mt-12">
    <h1 class="text-4xl font-bold text-white">Perfil de Usuario</h1>
    <p class="text-gray-400 mt-4">Aquí puedes actualizar tu información personal.</p>
</div>
<div class="mt-8 max-w-md mx-auto bg-gray-800 bg-opacity-80 p-8 rounded-lg shadow-lg">
    ...
    <form method="POST" action="{{ route('profile.update') }}">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" id="name" value="{{ Auth::user()->name }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-opacity-50">
        </div>
        <div class="mb-4">
            <label for="email" class="block text-sm font-medium text-gray-400">Email</label>
            <input type="email" name="email" id="email" value="{{ Auth::user()->email }}" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-opacity-50">
        </div>
        <button type="submit" class="bg-purple-600 text-white px-4 py-2 rounded-md shadow hover:bg-purple-700">Actualizar</button>
    </form>
</div>
